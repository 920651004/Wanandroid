 ...
 * @Package: com.duan.wanandroid.bean
 * @ClassName: SearchListBean
 * @Description: java类作用描述
 * @Author: Duan
 * @CreateDate: 2019/11/18 15:02
 * @UpdateUser: 更新者：
 * @UpdateDate: 2019/11/18 15:02
 * @UpdateRemark: 更新说明：
 * @Version: 1.0
 */
